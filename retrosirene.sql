...
SELECT
  s.siren,
  e.nic,
  coalesce(e.denominationusuelleetablissement, e.enseigne1etablissement, e.enseigne2etablissement, e.enseigne3etablissement, nomusageunitelegale, nomunitelegale) as l1_normalise,
  '' as l2_normalisee,
  '' as l3_normalisee,
  ...
  coalesce(e.denominationusuelleetablissement, e.enseigne1etablissement, e.enseigne2etablissement, e.enseigne3etablissement, nomusageunitelegale, nomunitelegale) as l1_declaree,
  '' as l2_declaree,
  '' as l3_declareeee,
